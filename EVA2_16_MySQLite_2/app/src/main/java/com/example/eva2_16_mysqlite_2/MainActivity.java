...
try {
    sqlDB.execSQL("insert into mitabla(nombre, apellido) values('EL NEGRO', 'MENDOZA')");
    sqlDB.execSQL("insert into mitabla(nombre, apellido) values('EL NEGRAZO', 'MEND')");
  //  int i = 1/0;
    sqlDB.execSQL("insert into mitabla(nombre, apellido) values('EL NEGROLOCO', 'MENDOCEÑO')");
    sqlDB.execSQL("insert into mitabla(nombre, apellido) values('EL', 'MELENDEZ')");
    sqlDB.execSQL("insert into mitabla(nombre, apellido) values('EL NEGRA', 'MENDOZAZ')");
